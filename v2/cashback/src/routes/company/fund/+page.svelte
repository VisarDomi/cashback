<script lang="ts">
	...
	function refresh() {
		...
		if (escrow) escrowBalance = escrow.balance;
	}
...
<div class="fund-page">
	...
	<div class="balance-info">
		...
		<span class="bal-amount">{formatCurrency(escrowBalance)}</span>
	</div>
	...
	{#if success}
		<div class="success-card">
			...
			<p>{formatCurrency(depositedAmount)} u shtuan në eskrou</p>
		...
		<div class="form">
			...
			<div class="presets">
				{#each [5000, 10000, 25000, 50000] as preset}
					<button class="preset-btn" onclick={() => amount = String(preset)}>
			...
			<button class="btn-primary" onclick={handleDeposit} disabled={!amount}>
				Depozito
			</button>
		</div>
	{/if}
